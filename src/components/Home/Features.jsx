...
const Features = () => {
  return (
    <div className="mt-24 py-24 px-10 flex flex-col items-center justify-between space-y-12 bg-[#060606]" id="features">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start justify-between">
        {
          featuresData.map((feature, index) => (
            ...
            >
              {feature.icon}
              <h1 className="uppercase font-bold text-xl text-white">{feature.title}</h1>
